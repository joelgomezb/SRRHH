use utf8;
package SRRHH::Schema::Result::Pai;
...
Related object: L<SRRHH::Schema::Result::Elegibleestudio>

=cut

__PACKAGE__->has_many(
  "elegibleestudios",
  "SRRHH::Schema::Result::Elegibleestudio",
...
Related object: L<SRRHH::Schema::Result::Regioncontinente>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:FbQMWjXAZ4PKyfwKHDfXnA
