use utf8;
package SRRHH::Schema::Result::Idioma;
...
=head1 TABLE: C<idioma>

=cut

__PACKAGE__->table("idioma");
...
__PACKAGE__->set_primary_key("id_idioma");
...
__PACKAGE__->add_unique_constraint("idioma_cod", ["id_personal", "id_tipo_idioma"]);
...
Related object: L<SRRHH::Schema::Result::Tipoidioma>

=cut

__PACKAGE__->belongs_to(
  "id_tipo_idioma",
  "SRRHH::Schema::Result::Tipoidioma",
  { id_tipo_idioma => "id_tipo_idioma" },
  { is_deferrable => 0, on_delete => "SET NULL", on_update => "NO ACTION" },
);


# Created by DBIx::Class::Schema::Loader v0.07045 @ 2016-10-11 14:37:38
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:y3P9/tLlb9MbW1qI7iolLA
