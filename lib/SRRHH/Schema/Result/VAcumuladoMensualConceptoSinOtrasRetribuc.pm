use utf8;
package SRRHH::Schema::Result::VAcumuladoMensualConceptoSinOtrasRetribuc;
...
SRRHH::Schema::Result::VAcumuladoMensualConceptoSinOtrasRetribuc
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:K3d2Y8QniwsLIJFsNOTHVw
