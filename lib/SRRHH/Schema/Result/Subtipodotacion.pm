use utf8;
package SRRHH::Schema::Result::Subtipodotacion;
...
Related object: L<SRRHH::Schema::Result::Tipodotacion>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:FPiBPWq0MZQUZczgPrkhzA
