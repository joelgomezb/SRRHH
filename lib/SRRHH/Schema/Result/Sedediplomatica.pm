use utf8;
package SRRHH::Schema::Result::Sedediplomatica;
...
Related object: L<SRRHH::Schema::Result::Tiposede>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:DWrvXAjci4gqZpmceY/+hg
