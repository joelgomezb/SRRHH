use utf8;
package SRRHH::Schema::Result::VAcumuladoMensualConcepto;
...
SRRHH::Schema::Result::VAcumuladoMensualConcepto
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:lLEr/p3noevmePaj9E0R7w
