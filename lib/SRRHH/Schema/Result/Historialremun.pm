use utf8;
package SRRHH::Schema::Result::Historialremun;
...
Related object: L<SRRHH::Schema::Result::Movremuneracion>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:qncwoNwF/AX8ryqvDEChXw
