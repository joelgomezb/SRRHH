use utf8;
package SRRHH::Schema::Result::ConceptofijoAuditoria;
...
SRRHH::Schema::Result::ConceptofijoAuditoria
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:vlixzbnxDCS9OkNNhi/U+g
