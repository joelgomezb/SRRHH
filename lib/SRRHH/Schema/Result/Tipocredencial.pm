use utf8;
package SRRHH::Schema::Result::Tipocredencial;
...
Related object: L<SRRHH::Schema::Result::Subtipocredencial>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ExgXvRdmKZc1yc4knJ1YlQ
