use utf8;
package SRRHH::Schema::Result::Baremopreseleccionado;
...
SRRHH::Schema::Result::Baremopreseleccionado
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:4e45JXpa4Eb/Ha7sHQCfCA
