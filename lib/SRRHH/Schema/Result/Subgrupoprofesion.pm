use utf8;
package SRRHH::Schema::Result::Subgrupoprofesion;
...
Related object: L<SRRHH::Schema::Result::Profesion>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:tJOURBdRGiB8mNiLIZXMLQ
