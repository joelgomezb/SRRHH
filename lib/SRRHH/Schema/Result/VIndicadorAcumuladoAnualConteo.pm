use utf8;
package SRRHH::Schema::Result::VIndicadorAcumuladoAnualConteo;
...
SRRHH::Schema::Result::VIndicadorAcumuladoAnualConteo
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+tswyfkqcL7OVjL3qPPaTw
