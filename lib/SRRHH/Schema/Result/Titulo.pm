use utf8;
package SRRHH::Schema::Result::Titulo;
...
Related object: L<SRRHH::Schema::Result::Grupoprofesion>

=cut

__PACKAGE__->belongs_to(
  "id_grupo_profesion",
  "SRRHH::Schema::Result::Grupoprofesion",
...
Related object: L<SRRHH::Schema::Result::Niveleducativo>

=cut

__PACKAGE__->belongs_to(
  "id_nivel_educativo",
  "SRRHH::Schema::Result::Niveleducativo",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:21L1Q8WQSmiUNvHxJ6ytEQ
