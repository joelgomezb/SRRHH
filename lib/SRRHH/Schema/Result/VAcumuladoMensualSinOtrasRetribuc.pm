use utf8;
package SRRHH::Schema::Result::VAcumuladoMensualSinOtrasRetribuc;
...
SRRHH::Schema::Result::VAcumuladoMensualSinOtrasRetribuc
...
=head1 TABLE: C<v_acumulado_mensual_sin_otras_retribuc>

=cut

__PACKAGE__->table("v_acumulado_mensual_sin_otras_retribuc");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:zrbZ14L3rgtP7OG3+KiRMg
