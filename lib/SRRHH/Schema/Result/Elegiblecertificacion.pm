use utf8;
package SRRHH::Schema::Result::Elegiblecertificacion;
...
SRRHH::Schema::Result::Elegiblecertificacion
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:soGyGtDrZrZGeNBCacfMGA
