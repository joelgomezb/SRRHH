use utf8;
package SRRHH::Schema::Result::Reconocimiento;
...
Related object: L<SRRHH::Schema::Result::Tiporeconocimiento>

=cut

__PACKAGE__->belongs_to(
  "id_tipo_reconocimiento",
  "SRRHH::Schema::Result::Tiporeconocimiento",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Ya6rJbZXZTW7IUNA11VYpA
