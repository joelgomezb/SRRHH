use utf8;
package SRRHH::Schema::Result::Planpersonal;
...
Related object: L<SRRHH::Schema::Result::Cargosplan>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:E02tFlGrCyWg8B7ELIc08w
