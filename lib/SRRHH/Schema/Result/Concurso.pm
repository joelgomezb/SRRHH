use utf8;
package SRRHH::Schema::Result::Concurso;
...
Related object: L<SRRHH::Schema::Result::Concursocargo>

=cut

__PACKAGE__->has_many(
  "concursocargoes",
  "SRRHH::Schema::Result::Concursocargo",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:t20X5POGumsXTfR9U5wBcQ
