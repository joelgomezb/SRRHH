use utf8;
package SRRHH::Schema::Result::Parametrobecageneral;
...
SRRHH::Schema::Result::Parametrobecageneral
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:eXo6N0XKCZS8mJe4YodRwQ
