use utf8;
package SRRHH::Schema::Result::VAcumuladoMensual;
...
SRRHH::Schema::Result::VAcumuladoMensual
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:JoWQ/actKxk1yl9iVTuy0w
