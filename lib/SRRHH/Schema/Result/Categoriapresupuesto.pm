use utf8;
package SRRHH::Schema::Result::Categoriapresupuesto;
...
SRRHH::Schema::Result::Categoriapresupuesto
...
Related object: L<SRRHH::Schema::Result::Seguridadpresupuesto>

=cut

__PACKAGE__->has_many(
  "seguridadpresupuestoes",
  "SRRHH::Schema::Result::Seguridadpresupuesto",
  {
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:G3ZC+rjYPGfpCTQywEla5A
