use utf8;
package SRRHH::Schema::Result::Causamovimiento;
...
Related object: L<SRRHH::Schema::Result::Movimientopersonal>

=cut

__PACKAGE__->belongs_to(
  "id_movimiento_personal",
  "SRRHH::Schema::Result::Movimientopersonal",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:sVadAwLWigdQw3YualzZPQ
