use utf8;
package SRRHH::Schema::Result::Usuario;
...
Related object: L<SRRHH::Schema::Result::Usuariorol>
...
Related object: L<SRRHH::Schema::Result::Usuariounidadfuncional>

=cut

__PACKAGE__->has_many(
  "usuariounidadfuncionals",
  "SRRHH::Schema::Result::Usuariounidadfuncional",
  { "foreign.id_usuario" => "self.id_usuario" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+yaOspvSRA9XI5XqzV8RlA
