use utf8;
package SRRHH::Schema::Result::Carreraarea;
...
Related object: L<SRRHH::Schema::Result::Areacarrera>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:YiRX3O/Z88oiBcEkBootDA
