use utf8;
package SRRHH::Schema::Result::Prestacionesonapre;
...
SRRHH::Schema::Result::Prestacionesonapre
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:dEG0pIAHVVb1Bm3yeC064g
