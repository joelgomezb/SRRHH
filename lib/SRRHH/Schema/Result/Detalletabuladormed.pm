use utf8;
package SRRHH::Schema::Result::Detalletabuladormed;
...
SRRHH::Schema::Result::Detalletabuladormed
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:8WnQRr5hpwKPrkPF4WTQzQ
