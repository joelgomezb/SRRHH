use utf8;
package SRRHH::Schema::Result::Contrato;
...
Related object: L<SRRHH::Schema::Result::Tipocontrato>

=cut

__PACKAGE__->belongs_to(
  "id_tipo_contrato",
  "SRRHH::Schema::Result::Tipocontrato",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:mCtYyjb1CcGqg1iYByWRlw
