use utf8;
package SRRHH::Schema::Result::VDatosPersonalesEvaluacione;
...
SRRHH::Schema::Result::VDatosPersonalesEvaluacione
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:60z4AMltEWycrwY9iAG1ug
