use utf8;
package SRRHH::Schema::Result::Dependencia;
...
Related object: L<SRRHH::Schema::Result::Aperturaescolar>
...
Related object: L<SRRHH::Schema::Result::Clasificaciondependencia>
...
Related object: L<SRRHH::Schema::Result::Tipodependencia>

=cut

__PACKAGE__->belongs_to(
  "id_tipo_dependencia",
  "SRRHH::Schema::Result::Tipodependencia",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:qPFC3dK8nI2QIoOOPuLCkQ
