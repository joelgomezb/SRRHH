use utf8;
package SRRHH::Schema::Result::Gradodocente;
...
Related object: L<SRRHH::Schema::Result::Gradoniveldocente>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:C5xAG8in7qj0d+Ptl5ECnQ
