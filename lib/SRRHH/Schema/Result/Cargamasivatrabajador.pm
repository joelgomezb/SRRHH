use utf8;
package SRRHH::Schema::Result::Cargamasivatrabajador;
...
SRRHH::Schema::Result::Cargamasivatrabajador
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:1qzHKDIq8QE8RnalNSx7Xw
