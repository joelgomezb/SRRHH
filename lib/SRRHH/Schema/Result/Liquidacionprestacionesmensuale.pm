use utf8;
package SRRHH::Schema::Result::Liquidacionprestacionesmensuale;
...
SRRHH::Schema::Result::Liquidacionprestacionesmensuale
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:0T8lpB1+MTRzwGOGGg5Swg
