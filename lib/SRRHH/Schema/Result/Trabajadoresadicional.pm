use utf8;
package SRRHH::Schema::Result::Trabajadoresadicional;
...
SRRHH::Schema::Result::Trabajadoresadicional
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:pKx7lRyTQM1yBGFDHvWWoQ
