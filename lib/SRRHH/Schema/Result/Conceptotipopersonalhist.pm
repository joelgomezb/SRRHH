use utf8;
package SRRHH::Schema::Result::Conceptotipopersonalhist;
...
SRRHH::Schema::Result::Conceptotipopersonalhist
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:JaFSaMerbyElTL0nXiZeXg
