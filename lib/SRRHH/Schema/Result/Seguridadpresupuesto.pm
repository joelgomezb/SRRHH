use utf8;
package SRRHH::Schema::Result::Seguridadpresupuesto;
...
Related object: L<SRRHH::Schema::Result::Categoriapresupuesto>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:U+Pua6h8bRNx0HjJBjNVlQ
