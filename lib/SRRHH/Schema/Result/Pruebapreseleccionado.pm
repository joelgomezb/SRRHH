use utf8;
package SRRHH::Schema::Result::Pruebapreseleccionado;
...
SRRHH::Schema::Result::Pruebapreseleccionado
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:KMrcXySCPLxZFty2uTOssA
