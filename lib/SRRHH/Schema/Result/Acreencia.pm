use utf8;
package SRRHH::Schema::Result::Acreencia;
...
Related object: L<SRRHH::Schema::Result::Tipoacreencia>

=cut

__PACKAGE__->belongs_to(
  "id_tipo_acreencia",
  "SRRHH::Schema::Result::Tipoacreencia",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:duXclImKzAFESG1lG4Yktw
