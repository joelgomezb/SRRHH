use utf8;
package SRRHH::Schema::Result::Elegibleafiliacion;
...
Related object: L<SRRHH::Schema::Result::Gremio>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:3IbArUU15ihmBFPSi78KXg
