use utf8;
package SRRHH::Schema::Result::Tipoacreencia;
...
Related object: L<SRRHH::Schema::Result::Acreencia>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:PwauHk0EdEh+ywpazNcIdA
