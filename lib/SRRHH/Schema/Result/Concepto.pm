use utf8;
package SRRHH::Schema::Result::Concepto;
...
Related object: L<SRRHH::Schema::Result::Detalledisquete>
...
Related object: L<SRRHH::Schema::Result::Embargoconcepto>

=cut

__PACKAGE__->has_many(
  "embargoconceptoes",
  "SRRHH::Schema::Result::Embargoconcepto",
  { "foreign.id_concepto" => "self.id_concepto" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<SRRHH::Schema::Result::Sindicato>

=cut

__PACKAGE__->has_many(
  "sindicatoes",
  "SRRHH::Schema::Result::Sindicato",
  { "foreign.id_concepto" => "self.id_concepto" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:nA4vgZZvhzb5tcffjlwKNw
