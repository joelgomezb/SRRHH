use utf8;
package SRRHH::Schema::Result::Elegibleexperiencia;
...
SRRHH::Schema::Result::Elegibleexperiencia
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:aNuXj/hf/+Ok6sZ1LkQfmA
