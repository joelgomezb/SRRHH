use utf8;
package SIGEFIRRHH::Schema::Result::Accionevaluacion;
...
SIGEFIRRHH::Schema::Result::Accionevaluacion
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:N6IR7r+MPGK8xJSuVXDVRg
