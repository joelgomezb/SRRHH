use utf8;
package SIGEFIRRHH::Schema::Result::Jerarquiacategoriadocente;
...
Related object: L<SIGEFIRRHH::Schema::Result::Categoriadocente>
...
Related object: L<SIGEFIRRHH::Schema::Result::Jerarquiadocente>

=cut

__PACKAGE__->belongs_to(
  "id_jerarquia_docente",
  "SIGEFIRRHH::Schema::Result::Jerarquiadocente",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:GSMWaBpFXfReljSgGND1fA
