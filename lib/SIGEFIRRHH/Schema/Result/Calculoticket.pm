use utf8;
package SIGEFIRRHH::Schema::Result::Calculoticket;
...
=head1 TABLE: C<calculoticket>

=cut

__PACKAGE__->table("calculoticket");

=head1 ACCESSORS

=head2 id_calculo_ticket
...
=item * L</id_calculo_ticket>

=back

=cut

__PACKAGE__->set_primary_key("id_calculo_ticket");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+sMw7DgCM4pBzchg/hHUPw
