use utf8;
package SIGEFIRRHH::Schema::Result::Grupoorganismo;
...
Related object: L<SIGEFIRRHH::Schema::Result::Parametrogobierno>

=cut

__PACKAGE__->might_have(
  "parametrogobierno",
  "SIGEFIRRHH::Schema::Result::Parametrogobierno",
  { "foreign.id_grupo_organismo" => "self.id_grupo_organismo" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:oEvEYbJxi+TYeY3Ddleqqw
