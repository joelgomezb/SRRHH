use utf8;
package SIGEFIRRHH::Schema::Result::Conceptoliquidacion;
...
=head1 TABLE: C<conceptoliquidacion>

=cut

__PACKAGE__->table("conceptoliquidacion");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:BdYL1qwenu8/uVfWGyePKQ
