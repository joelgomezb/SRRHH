use utf8;
package SIGEFIRRHH::Schema::Result::Conceptopresupuesto;
...
=head1 TABLE: C<conceptopresupuesto>

=cut

__PACKAGE__->table("conceptopresupuesto");

=head1 ACCESSORS

=head2 id_concepto_presupuesto
...
=item * L</id_concepto_presupuesto>

=back

=cut

__PACKAGE__->set_primary_key("id_concepto_presupuesto");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Mjx1uSFPJp3kC5a0jXveaw
