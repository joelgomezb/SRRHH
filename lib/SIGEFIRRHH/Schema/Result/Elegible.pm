use utf8;
package SIGEFIRRHH::Schema::Result::Elegible;
...
Related object: L<SIGEFIRRHH::Schema::Result::Elegiblehabilidad>
...
Related object: L<SIGEFIRRHH::Schema::Result::Elegibleorganismo>
...
Related object: L<SIGEFIRRHH::Schema::Result::Elegibleotraactividad>

=cut

__PACKAGE__->has_many(
  "elegibleotraactividads",
  "SIGEFIRRHH::Schema::Result::Elegibleotraactividad",
  { "foreign.id_elegible" => "self.id_elegible" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:U/0VPSHnonqgQechTjl6Qw
