use utf8;
package SIGEFIRRHH::Schema::Result::Anticipo;
...
=head1 TABLE: C<anticipo>

=cut

__PACKAGE__->table("anticipo");
...
__PACKAGE__->set_primary_key("id_anticipo");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:rjgFyZ0WTBeFYazSDTGy9w
