use utf8;
package SIGEFIRRHH::Schema::Result::Elegibleeducacion;
...
SIGEFIRRHH::Schema::Result::Elegibleeducacion
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:CKhZnRZK4NQTz1Jtkh8eww
