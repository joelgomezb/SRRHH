use utf8;
package SIGEFIRRHH::Schema::Result::Movimientosplan;
...
SIGEFIRRHH::Schema::Result::Movimientosplan
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:bOgI3pCIRuLq1NhiKpbAXQ
