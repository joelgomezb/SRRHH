use utf8;
package SIGEFIRRHH::Schema::Result::Puebloindigena;
...
SIGEFIRRHH::Schema::Result::Puebloindigena
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:tlt0IUDSHFKf5Sjc3Usi5Q
