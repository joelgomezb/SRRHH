use utf8;
package SIGEFIRRHH::Schema::Result::Seguridadticket;
...
SIGEFIRRHH::Schema::Result::Seguridadticket
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:wgWK6fr5UGfxOGS1fhUqXw
