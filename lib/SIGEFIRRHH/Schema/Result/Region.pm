use utf8;
package SIGEFIRRHH::Schema::Result::Region;
...
Related object: L<SIGEFIRRHH::Schema::Result::Proveedorregion>

=cut

__PACKAGE__->has_many(
  "proveedorregions",
  "SIGEFIRRHH::Schema::Result::Proveedorregion",
  { "foreign.id_region" => "self.id_region" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:IpEUnsDwNS23fwIrdFbHXg
