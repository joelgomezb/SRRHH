use utf8;
package SIGEFIRRHH::Schema::Result::Tipocaracteristica;
...
SIGEFIRRHH::Schema::Result::Tipocaracteristica
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:StQeijjC4o6pzgVsS0wf4g
