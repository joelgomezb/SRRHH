use utf8;
package SIGEFIRRHH::Schema::Result::VDatosPersonalesCarnet;
...
SIGEFIRRHH::Schema::Result::VDatosPersonalesCarnet
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:614PimMTeBMdUVTmxRsoDw
