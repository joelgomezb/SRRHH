use utf8;
package SIGEFIRRHH::Schema::Result::Resumenmensual;
...
SIGEFIRRHH::Schema::Result::Resumenmensual
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:LnB9GGdtGNYmbdfrG9NK4A
