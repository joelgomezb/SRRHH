use utf8;
package SIGEFIRRHH::Schema::Result::VRecibosEspecial;
...
SIGEFIRRHH::Schema::Result::VRecibosEspecial
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:JqWBWcwcF0fuAd1Ln4RshA
