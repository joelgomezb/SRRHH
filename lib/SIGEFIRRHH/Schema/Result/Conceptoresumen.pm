use utf8;
package SIGEFIRRHH::Schema::Result::Conceptoresumen;
...
SIGEFIRRHH::Schema::Result::Conceptoresumen
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:SbnYF4UdFEx+xs31Jfzx2w
