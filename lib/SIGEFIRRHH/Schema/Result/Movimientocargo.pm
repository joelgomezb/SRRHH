use utf8;
package SIGEFIRRHH::Schema::Result::Movimientocargo;
...
SIGEFIRRHH::Schema::Result::Movimientocargo
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:5GpshSj196A3nWvRpZ9Fjg
