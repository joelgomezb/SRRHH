use utf8;
package SIGEFIRRHH::Schema::Result::Informacionmpd;
...
SIGEFIRRHH::Schema::Result::Informacionmpd
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:xh78xexAwhIelgFsSckRrA
