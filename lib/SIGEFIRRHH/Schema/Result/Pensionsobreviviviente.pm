use utf8;
package SIGEFIRRHH::Schema::Result::Pensionsobreviviviente;
...
SIGEFIRRHH::Schema::Result::Pensionsobreviviviente
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Y5kp57ilYI9gbxnMNJ3pyA
