use utf8;
package SIGEFIRRHH::Schema::Result::Escalacuadroonapre;
...
SIGEFIRRHH::Schema::Result::Escalacuadroonapre
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:HwUTRQIhPgbGtM0IczeuJA
