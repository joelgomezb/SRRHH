use utf8;
package SIGEFIRRHH::Schema::Result::Ausencia;
...
Related object: L<SIGEFIRRHH::Schema::Result::Tipoausencia>

=cut

__PACKAGE__->belongs_to(
  "id_tipo_ausencia",
  "SIGEFIRRHH::Schema::Result::Tipoausencia",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:vHv3N4Xo0KdqqrGUnQqOOA
