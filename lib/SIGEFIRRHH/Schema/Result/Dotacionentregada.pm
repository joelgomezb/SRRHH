use utf8;
package SIGEFIRRHH::Schema::Result::Dotacionentregada;
...
SIGEFIRRHH::Schema::Result::Dotacionentregada
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+w7WpTFhjGXpZhGwkW8D4A
