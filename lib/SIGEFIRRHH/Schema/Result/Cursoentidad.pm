use utf8;
package SIGEFIRRHH::Schema::Result::Cursoentidad;
...
Related object: L<SIGEFIRRHH::Schema::Result::Curso>

=cut

__PACKAGE__->belongs_to(
  "id_curso",
  "SIGEFIRRHH::Schema::Result::Curso",
  { id_curso => "id_curso" },
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:rU1XsAoL/ToXLJ/2hW73zg
