use utf8;
package SIGEFIRRHH::Schema::Result::Liquidacioninteresadicional;
...
=head1 TABLE: C<liquidacioninteresadicional>

=cut

__PACKAGE__->table("liquidacioninteresadicional");

=head1 ACCESSORS

=head2 id_liquidacion_interes_adicional
...
=item * L</id_liquidacion_interes_adicional>

=back

=cut

__PACKAGE__->set_primary_key("id_liquidacion_interes_adicional");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:LKUZ7dGWxzb1CjdnSBcbiw
