use utf8;
package SIGEFIRRHH::Schema::Result::Historialapn;
...
=head1 TABLE: C<historialapn>

=cut

__PACKAGE__->table("historialapn");

=head1 ACCESSORS

=head2 id_historial_apn
...
=item * L</id_historial_apn>

=back

=cut

__PACKAGE__->set_primary_key("id_historial_apn");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:a39CEVaSdgTogmfOkC8gag
