use utf8;
package SIGEFIRRHH::Schema::Result::Tiposiniestro;
...
SIGEFIRRHH::Schema::Result::Tiposiniestro
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Z+lxEfjsTpBT4aJm4gEPuA
