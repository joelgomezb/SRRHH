use utf8;
package SIGEFIRRHH::Schema::Result::VArchivoPlanoBiv;
...
SIGEFIRRHH::Schema::Result::VArchivoPlanoBiv
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:xKuCAwuvzm50rdruAF58OQ
