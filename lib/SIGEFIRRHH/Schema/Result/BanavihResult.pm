use utf8;
package SIGEFIRRHH::Schema::Result::BanavihResult;
...
SIGEFIRRHH::Schema::Result::BanavihResult
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:bTD8WRqX9uenMNYP2Xm98Q
