use utf8;
package SIGEFIRRHH::Schema::Result::Elegiblepublicacion;
...
SIGEFIRRHH::Schema::Result::Elegiblepublicacion
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:CAQj0GgVGRveD3bHlZeoLQ
