use utf8;
package SIGEFIRRHH::Schema::Result::VArchivoPlanoBivOctubre2012;
...
SIGEFIRRHH::Schema::Result::VArchivoPlanoBivOctubre2012
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:QDVqkJrS3A+dta+1fAdScw
