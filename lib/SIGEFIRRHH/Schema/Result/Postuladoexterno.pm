use utf8;
package SIGEFIRRHH::Schema::Result::Postuladoexterno;
...
SIGEFIRRHH::Schema::Result::Postuladoexterno
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:0QDjWqthsl6erhv9YsZnUQ
