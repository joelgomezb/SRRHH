use utf8;
package SIGEFIRRHH::Schema::Result::Habilidad;
...
=head1 TABLE: C<habilidad>

=cut

__PACKAGE__->table("habilidad");
...
__PACKAGE__->set_primary_key("id_habilidad");

=head1 UNIQUE CONSTRAINTS

=head2 C<habilidad_cod>
...
__PACKAGE__->add_unique_constraint("habilidad_cod", ["id_personal", "id_tipo_habilidad"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:hHcIc2gSijuHsmB9P7o0NA
