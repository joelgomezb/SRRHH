use utf8;
package SIGEFIRRHH::Schema::Result::Conceptoevaluacion;
...
SIGEFIRRHH::Schema::Result::Conceptoevaluacion
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Bv1EWwrayCLZsz9nPKjNDQ
