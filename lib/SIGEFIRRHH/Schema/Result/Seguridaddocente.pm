use utf8;
package SIGEFIRRHH::Schema::Result::Seguridaddocente;
...
SIGEFIRRHH::Schema::Result::Seguridaddocente
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:o0Lcv9vT81ecUsxmZCLXwg
