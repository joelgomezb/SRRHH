use utf8;
package SIGEFIRRHH::Schema::Result::Caracteristicadependencia;
...
SIGEFIRRHH::Schema::Result::Caracteristicadependencia
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:N2hg6F3+06GXKrUgo9ReVA
