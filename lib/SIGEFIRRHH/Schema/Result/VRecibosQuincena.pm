use utf8;
package SIGEFIRRHH::Schema::Result::VRecibosQuincena;
...
SIGEFIRRHH::Schema::Result::VRecibosQuincena
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:cbyUk7wyH5O9FlAYG3VZlA
