use utf8;
package SIGEFIRRHH::Schema::Result::Conceptoproyectado;
...
SIGEFIRRHH::Schema::Result::Conceptoproyectado
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:YRctooTtrwH/iq88pDwjgg
