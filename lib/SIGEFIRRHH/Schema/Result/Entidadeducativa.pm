use utf8;
package SIGEFIRRHH::Schema::Result::Entidadeducativa;
...
Related object: L<SIGEFIRRHH::Schema::Result::Cursoentidad>

=cut

__PACKAGE__->has_many(
  "cursoentidads",
  "SIGEFIRRHH::Schema::Result::Cursoentidad",
...
Related object: L<SIGEFIRRHH::Schema::Result::Tipoentidad>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Td14ynCbYJF80NtM1hfrTQ
