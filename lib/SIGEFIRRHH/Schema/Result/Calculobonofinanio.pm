use utf8;
package SIGEFIRRHH::Schema::Result::Calculobonofinanio;
...
=head1 TABLE: C<calculobonofinanio>

=cut

__PACKAGE__->table("calculobonofinanio");

=head1 ACCESSORS

=head2 id_calculo_bono_fin_anio
...
=item * L</id_calculo_bono_fin_anio>

=back

=cut

__PACKAGE__->set_primary_key("id_calculo_bono_fin_anio");

=head1 UNIQUE CONSTRAINTS

=head2 C<calculobonofinanio_cod>
...
__PACKAGE__->add_unique_constraint("calculobonofinanio_cod", ["id_trabajador"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:CLRV2PbsVmWrGVgLvE7pEw
