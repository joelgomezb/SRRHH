use utf8;
package SIGEFIRRHH::Schema::Result::Tabulador;
...
Related object: L<SIGEFIRRHH::Schema::Result::Ajustetabuladoronu>
...
Related object: L<SIGEFIRRHH::Schema::Result::Detalletabuladormre>
...
Related object: L<SIGEFIRRHH::Schema::Result::Detalletabuladoronu>

=cut

__PACKAGE__->has_many(
  "detalletabuladoronus",
  "SIGEFIRRHH::Schema::Result::Detalletabuladoronu",
  { "foreign.id_tabulador" => "self.id_tabulador" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:kZj4F3cdUKIZKzVQrw6ppg
