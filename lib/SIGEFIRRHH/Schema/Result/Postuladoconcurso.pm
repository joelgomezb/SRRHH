use utf8;
package SIGEFIRRHH::Schema::Result::Postuladoconcurso;
...
SIGEFIRRHH::Schema::Result::Postuladoconcurso
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:BWIq1zhGGAc4jsk53+fT+Q
