use utf8;
package SIGEFIRRHH::Schema::Result::Dependenciajudicial;
...
Related object: L<SIGEFIRRHH::Schema::Result::Operacion>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:uikbVLc6MQw4XYwLmqYtaw
