use utf8;
package SIGEFIRRHH::Schema::Result::Dedicaciondocente;
...
SIGEFIRRHH::Schema::Result::Dedicaciondocente
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:o36dfNQodpkJtGKIt2OqUQ
