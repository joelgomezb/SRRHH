use utf8;
package SIGEFIRRHH::Schema::Result::Subtipocredencial;
...
Related object: L<SIGEFIRRHH::Schema::Result::Tipocredencial>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:mk1hvS9IICHutP8uqVSxKg
