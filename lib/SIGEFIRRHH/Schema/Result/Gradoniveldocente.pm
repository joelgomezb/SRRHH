use utf8;
package SIGEFIRRHH::Schema::Result::Gradoniveldocente;
...
Related object: L<SIGEFIRRHH::Schema::Result::Gradodocente>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:o7Q+lKn9/0sMpV2p+IwIGw
