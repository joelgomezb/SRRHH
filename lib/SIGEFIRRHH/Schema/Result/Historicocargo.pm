use utf8;
package SIGEFIRRHH::Schema::Result::Historicocargo;
...
SIGEFIRRHH::Schema::Result::Historicocargo
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:n6Vd+oIMixPiqYbdx/nUAg
