use utf8;
package SIGEFIRRHH::Schema::Result::Encabezadorendicionmensual;
...
SIGEFIRRHH::Schema::Result::Encabezadorendicionmensual
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:FGyO0vqXC6qR5U9IMMnpZA
