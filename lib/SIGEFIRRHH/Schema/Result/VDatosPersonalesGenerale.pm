use utf8;
package SIGEFIRRHH::Schema::Result::VDatosPersonalesGenerale;
...
SIGEFIRRHH::Schema::Result::VDatosPersonalesGenerale
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:mqJdTy39/rivd3aK7+RYog
