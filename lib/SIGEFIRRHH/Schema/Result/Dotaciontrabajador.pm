use utf8;
package SIGEFIRRHH::Schema::Result::Dotaciontrabajador;
...
Related object: L<SIGEFIRRHH::Schema::Result::Subtipodotacion>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:/QorJ7+j7vqUILviYeBCvQ
