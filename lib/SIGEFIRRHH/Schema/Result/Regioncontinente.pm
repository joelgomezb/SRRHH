use utf8;
package SIGEFIRRHH::Schema::Result::Regioncontinente;
...
Related object: L<SIGEFIRRHH::Schema::Result::Continente>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:LXCydCjjw77N5n+Vlm2ONg
