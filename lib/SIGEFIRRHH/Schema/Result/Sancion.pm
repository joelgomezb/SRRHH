use utf8;
package SIGEFIRRHH::Schema::Result::Sancion;
...
Related object: L<SIGEFIRRHH::Schema::Result::Tipoamonestacion>

=cut

__PACKAGE__->belongs_to(
  "id_tipo_amonestacion",
  "SIGEFIRRHH::Schema::Result::Tipoamonestacion",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+XNQseeb8Ey3bgbthB5Paw
