use utf8;
package SIGEFIRRHH::Schema::Result::ConceptovariableAuditoria;
...
SIGEFIRRHH::Schema::Result::ConceptovariableAuditoria
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:WlPP8A+Ugkfh47CZRRjxsQ
