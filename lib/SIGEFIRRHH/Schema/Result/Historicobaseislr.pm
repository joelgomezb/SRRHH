use utf8;
package SIGEFIRRHH::Schema::Result::Historicobaseislr;
...
SIGEFIRRHH::Schema::Result::Historicobaseislr
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:1hyZa+prd81Pb1/u33zImA
