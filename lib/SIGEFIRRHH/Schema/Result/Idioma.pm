use utf8;
package SIGEFIRRHH::Schema::Result::Idioma;
...
Related object: L<SIGEFIRRHH::Schema::Result::Tipoidioma>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ZYtEZBmzCNUXTOcmISn7kQ
