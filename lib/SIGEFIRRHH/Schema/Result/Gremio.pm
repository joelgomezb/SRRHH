use utf8;
package SIGEFIRRHH::Schema::Result::Gremio;
...
Related object: L<SIGEFIRRHH::Schema::Result::Elegibleafiliacion>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:e8ITaZ18jPAt7QI7iTiMqQ
