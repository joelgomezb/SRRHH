use utf8;
package SIGEFIRRHH::Schema::Result::VDatosPersonale;
...
SIGEFIRRHH::Schema::Result::VDatosPersonale
...
=head1 TABLE: C<v_datos_personales>

=cut

__PACKAGE__->table("v_datos_personales");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:0y7QWcfM4W66ESdjab26CA
