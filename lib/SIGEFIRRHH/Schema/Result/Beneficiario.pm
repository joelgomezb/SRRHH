use utf8;
package SIGEFIRRHH::Schema::Result::Beneficiario;
...
=item * L</id_beneficiario>

=back

=cut

__PACKAGE__->set_primary_key("id_beneficiario");

=head1 UNIQUE CONSTRAINTS

=head2 C<beneficiario_cod>
...
__PACKAGE__->add_unique_constraint("beneficiario_cod", ["id_personal", "id_familiar"]);
...
Related object: L<SIGEFIRRHH::Schema::Result::Primasplan>

=cut

__PACKAGE__->belongs_to(
  "id_primas_plan",
  "SIGEFIRRHH::Schema::Result::Primasplan",
...
__PACKAGE__->has_many(
  ...
  { "foreign.id_beneficiario" => "self.id_beneficiario" },
  { cascade_copy => 0, cascade_delete => 0 },
);


# Created by DBIx::Class::Schema::Loader v0.07045 @ 2016-10-18 11:26:13
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:eQfrSAobWvYb4/lHXa0wgQ
