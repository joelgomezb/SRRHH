use utf8;
package SIGEFIRRHH::Schema::Result::Ausencianomina;
...
=head1 TABLE: C<ausencianomina>

=cut

__PACKAGE__->table("ausencianomina");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:sIzCE55C70lQeJaVu44w9w
