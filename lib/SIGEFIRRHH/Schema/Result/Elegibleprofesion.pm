use utf8;
package SIGEFIRRHH::Schema::Result::Elegibleprofesion;
...
SIGEFIRRHH::Schema::Result::Elegibleprofesion
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:U2eWqAhvoMdy2Pbyl1dd2g
