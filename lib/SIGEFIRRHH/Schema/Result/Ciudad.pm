use utf8;
package SIGEFIRRHH::Schema::Result::Ciudad;
...
Related object: L<SIGEFIRRHH::Schema::Result::Sedediplomatica>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:P4Z8Co5XxDglHuRjwiL5Ig
